...
export function EmailAnalyzer() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-headline text-2xl">Bwenzi's Email Security Scan</CardTitle>
        <CardDescription>Paste the full content of a suspicious email below to get an instant security analysis from Bwenzi, your AI security assistant.</CardDescription>
      </CardHeader>
      <CardContent>
