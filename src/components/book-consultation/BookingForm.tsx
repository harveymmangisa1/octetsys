...
import { Bot, Send, CheckCircle2, Calendar } from "lucide-react";
  ...
  return (
    <section id="booking-form" className="py-16 sm:py-24 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <Card className="max-w-2xl mx-auto shadow-lg border-border/70">
            <CardHeader>
                <CardTitle className="font-headline text-2xl">Schedule Your Free Consultation</CardTitle>
                <CardDescription>Fill out the form below and we'll be in touch to confirm your booking.</CardDescription>
            </CardHeader>
            <CardContent>
                <form ref={formRef} action={formAction} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="message">Project Details / Questions</Label>
                        <Textarea 
                            id="message" 
                            name="message" 
