...
export const serviceData: IServiceData = {
    ...
    'security-awareness-training': {
        ...
        description: 'Master essential digital skills with our interactive training modules. From Python programming to AI tools, learn at your own pace with hands-on exercises.',
        category: 'Training & Education',
        highlights: ['Interactive learning', 'Self-paced modules', 'Downloadable badges', 'Real-world scenarios'],
        overview: 'Transform your skills with our comprehensive interactive training platform featuring hands-on exercises, real-time feedback, and practical applications.',
        benefits: ['Practical skills development', 'Flexible learning schedule', 'Industry-recognized badges', 'Immediate application'],
        methodology: ['Interactive lessons', 'Hands-on exercises', 'Progress tracking', 'Skill assessment'],
        deliverables: ['Digital badges', 'Completion certificates', 'Skill assessments', 'Learning pathways'],
        outcomes: ['Job-ready skills', 'Digital literacy', 'Technical proficiency', 'Continuous learning mindset'],
        complianceAlignment: ['Digital literacy standards', 'Industry best practices', 'Modern skill requirements'],
        pricing: [{ tier: 'Individual', summary: 'Access to all modules', startingAt: 'From $99' }, { tier: 'Team', summary: 'Team dashboard and reporting', startingAt: 'From $499/mo' }, { tier: 'Enterprise', summary: 'Custom modules and LMS integration', startingAt: 'From $1,999/mo' }],
        faqs: [{ q: 'How long do I have access to the modules?', a: 'You get lifetime access to all purchased modules with regular updates.' }, { q: 'Are the certificates recognized?', a: 'Yes, our badges and certificates are industry-recognized and can be shared on LinkedIn.' }]
    },
    'business-continuity': {
        icon: Shield,
