-- Update the RPC function to set status as 'approved' by default for now
...
BEGIN
    ...
    VALUES (violence_type_in, description_in, platform_in, severity_in, additional_details_in, 'approved')
