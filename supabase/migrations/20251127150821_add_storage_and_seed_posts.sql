...
-- Set up row-level security policies for the 'images' bucket
...
-- Seed the posts table with some initial content
-- This will only run once when the migration is applied.
